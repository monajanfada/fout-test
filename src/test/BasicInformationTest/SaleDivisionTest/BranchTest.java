...
import static test.Menu.BASIC_INFORMATION_SALEDIVISION_BRANCH;

public class BranchTest extends BaseTest {


    private static final String FARSI_NAME_CREATE = "شعبه لواسان";
    private static final String FARSI_NAME_EDIT = "شعبه ویرایش شده";
    public static final String NAME = "name";
    public static final String NEW_ITEM = "newItem";
    public static final String SUBMIT_BRANNCH = "submitBranch";
    ...
    public void internalTest() {
        login();
        saveBranch();
        searchBranch(FARSI_NAME_CREATE, false);
        editBranch();
        searchBranch(FARSI_NAME_EDIT, false);
        deleteBranch();
        searchBranch(FARSI_NAME_EDIT, true);

    }

    public void searchBranch(String farsiName, boolean isForDelete) {
    ...
    public void saveBranch() {
        ...
        // Clicking on Company
        clickMenu(BASIC_INFORMATION_SALEDIVISION_BRANCH);
